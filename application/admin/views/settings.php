            ...
            <form id="wizard_form" action="options.php" method="POST">
                ...
                <?php if ($warning = $that->preSettingsWarning()) : ?>
                    <div class="tmn-callout tmn-callout-warning mb-5">
                        <h5 class"alert-heading""><?php echo esc_attr(__('Please fix the following issues to continue:', 'independent-niche')); ?></h5>
                ...
                <div class="col-12 mt-4">
                    <?php if (Wizard::getInstance()->getCurrentStep() > 1) : ?>
                        ...
                        <a id="tmn_previous" class="btn btn-secondary" href="<?php echo esc_attr($previous_url); ?>" role="button">&#8592; <?php echo esc_attr(__('Previous', 'independent-niche')); ?></a>
                    <?php endif; ?>
