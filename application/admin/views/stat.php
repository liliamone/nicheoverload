    ...
    <div class="cegg5-container">
        <div class="col-12 p-2 p-md-4 pb-md-0">
            ...
            <h1 class="display-6 mb-4">
                ...
                <small class="text-muted h5"><?php echo esc_html(__('Statistics', 'too-much-niche')); ?></small>
            </h1>
                    ...
                    <tbody>
                        <tr>
                            <th class="col-md-3 col-lg-3 align-middle">
                                <?php echo esc_html(__('Status', 'too-much-niche')); ?>
                            </th>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3">
                                    ...
                                    <?php if ($task->isStatusWorking()) : ?>
                                        <div>
                                            ...
                                            <span class="text-primary fw-bold">
                                                <?php echo esc_html(__('In progress:', 'too-much-niche')); ?>
                                            </span>
                                            <?php echo esc_html(__('Generating/posting article...', 'too-much-niche')); ?>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if ($task->isStatusStopping()) : ?>
                                        <div>
                                            ...
                                            <span class="text-danger fw-bold"><?php echo esc_html(__('Stopping:', 'too-much-niche')); ?></span>
                                            <?php echo esc_html(__('Shutting down process...', 'too-much-niche')); ?>
                                        </div>
                                    <?php endif; ?>

                                    <?php if ($task->isStatusError()) : ?>
                                        <div class="badge text-bg-danger"><?php echo esc_html(__('Error', 'too-much-niche')); ?></div>
                                    <?php endif; ?>
                                    ...
                                    <?php if ($task->isStatusSuccess()) : ?>
                                        <div>
                                            <div class="text-success fw-bold">
                                                ...
                                                <?php echo esc_html(__('Done', 'too-much-niche')); ?>
                                            </div>
                                            <?php if ($remaining_credits > 0) : ?>
                                                <div class="small text-muted">
                                                    <?php echo esc_html(sprintf(__('Remaining article credits: %d', 'too-much-niche'), $remaining_credits)); ?>
                                                </div>
                                            <?php else : ?>
                                                <div class="small text-success">
                                                    <?php echo esc_html(__('All article generation credits have been used.', 'too-much-niche')); ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <a
                                        ...
                                        title="<?php echo esc_attr(__('Start New Task', 'too-much-niche')); ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                            <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
                                        </svg>
                                        <span class="ps-1"><?php echo esc_attr(__('New Task', 'too-much-niche')); ?></span>
                                    </a>
                                </div>
                        ...
                        <?php if ($in_queue) : ?>
                            <tr>
                                <th class="align-middle"><?php echo esc_html(__('Articles in queue', 'too-much-niche')); ?></th>
                                <td class="align-middle">
                                    <div class="d-flex align-items-center justify-content-between gap-3">
                                        ...
                                        <?php if ($task->isStatusWorking()): ?>
                                            <a
                                                ...
                                                title="<?php echo esc_attr(__('Stop Generation', 'too-much-niche')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-stop-fill" viewBox="0 0 16 16">
                                                    <path d="M5 3.5h6A1.5 1.5 0 0 1 12.5 5v6a1.5 1.5 0 0 1-1.5 1.5H5A1.5 1.5 0 0 1 3.5 11V5A1.5 1.5 0 0 1 5 3.5" />
                                                </svg>
                                                <span class="ps-1">&nbsp;<?php echo esc_attr(__('Stop All', 'too-much-niche')); ?>&nbsp;&nbsp;</span>
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                </td>
                        ...
                        <?php if (!$is_cron_enabled && !Plugin::isDevEnvironment()) : ?>
                            <tr>
                                <th class="text-info"><?php echo esc_html(__('Cron', 'too-much-niche')); ?></th>
                                <td class="text-muted small">
                                    <?php
                                    echo \esc_html(__('DISABLE_WP_CRON is set to true, disabling WP cron.', 'too-much-niche'));
                                    echo '<br>' . \esc_html(__('This plugin requires WordPress Cron to be enabled.', 'too-much-niche'));
                                    echo ' ' . \esc_html(__('If you use an alternative cron, the plugin will work, and you can ignore this notice.', 'too-much-niche'));
                                    ?>
                                </td>
                            </tr>
                        <?php endif; ?>
                        ...
                        <?php if ($is_import_error && $in_queue && !Plugin::isDevEnvironment()) : ?>
                            <tr>
                                <th class="text-info"><?php echo esc_html(__('Article Posting Failed', 'too-much-niche')); ?></th>
                                <td>
                                    <div class="small mb-2"><?php echo \esc_html(__("It appears that the import cron task is not currently running. Please ensure that the cron is properly configured and operational on your WordPress installation.", 'too-much-niche')); ?></div>
                                    <div class="text-end">
                                        <a style="width: 100px;" title="<?php echo esc_html(__('Post without Cron', 'too-much-niche')); ?>"
                                            ...
                                            <?php echo esc_html(__('Post Now', 'too-much-niche')); ?>
                                        </a>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <?php if ($task->isStatusSuccess() && $coupon) : ?>
                            <tr>
                                ...
                                <td colspan="1" class="pt-3 pb-3 text-center1">
                                    <div class="mb-2">
                                        <?php echo esc_html(sprintf(__('Use the exclusive coupon code "%s" for a 30%% discount on your next order.', 'too-much-niche'), $coupon)); ?>
                                    </div>
                                    ...
                                    <div class="small mt-2"><?php echo esc_html(sprintf(__("Valid for 3 days until %s", 'too-much-niche'), $coupon_date_formated)); ?></div>
                                </td>
                            </tr>
                        <?php endif; ?>
...
<div class="tmn">
    <div class="cegg5-container">
        <div class="col-sm-12 col-md-12 p-2 p-md-4">
            <div class="fs-4">
                <?php echo esc_html(__('Posted Articles', 'too-much-niche')); ?>

                <a class="ms-2 link-secondary"
                    title="<?php echo esc_attr(__('Reset Posted Articles Log', 'too-much-niche')); ?>"
